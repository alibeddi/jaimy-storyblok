...
// CategoryCard component types
export interface CategoryCardProps extends BaseUIProps {
  title: string;
  description?: string;
  icon: string;
  href?: string;
...
// CategorySection component types
export interface CategorySectionProps extends BaseUIProps {
  title?: string;
  subtitle?: string;
...
export namespace UITypes {
  ...
  export type CategoryCard = CategoryCardProps;
  export type CategorySection = CategorySectionProps;
}
