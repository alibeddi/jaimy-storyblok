    ...
    <article className={cn("w-full", className)} {...rest}>
      {blok?.image && (
        <div className="relative w-full">
          {/* Mobile Image */}
          {blok.image_mobile ? (
            <div className="md:hidden" data-blok-field="image_mobile">
              <Image
            ...
            <div className="md:hidden" data-blok-field="image">
              <Image
          ...
          {/* Desktop Image */}
          <div className="hidden md:block" data-blok-field="image">
            <Image
              src={blok?.image.filename}
              alt={blok?.image.alt || blok?.title}
              className={cn(
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-24 text-white z-10">
            {blok.updated && (
              <p data-blok-field="updated" className="text-sm mb-2">
                {formatDate(blok.updated)}
              </p>
            )}

            <h1
              data-blok-field="title"
              className="text-3xl md:text-5xl font-bold leading-tight mb-4 max-w-4xl">
              {blok.title}
            </h1>

            {blok.short_text && (
              <p
                data-blok-field="short_text"
