...
export default function Header({ blok }: { blok: HeaderBlok }) {
  ...
  const currentLanguage = useMemo(
    () =>
      supportedLanguages.find((l) => l.code === currentLocale) ??
  ...
  const handleSearch = useCallback(
    (e: React.FormEvent) => {
      ...
      if (searchQuery.trim()) {
        router.push(
          `/${currentLocale}/search?q=${encodeURIComponent(searchQuery.trim())}`
        );
        setMobileMenuOpen(false);
      }
    },
          ...
          {blok.logo && blok.logo.filename ? (
            ...
            <div className="flex items-center">
              <div className="flex flex-col">
                <span className="text-[#AF1B3C] font-bold text-xl font-[BelfiusMontserrat]">
                  jaimy
                </span>
                <span className="text-gray-400 text-sm font-[BelfiusMontserrat]">
                  by Belfius
                </span>
              </div>
            </div>
            ...
            <form onSubmit={handleSearch} className="relative">
              <div
                ...
                <button
                  ...
                  style={{
                    background:
                      "linear-gradient(180deg, #961E34 0%, #C30B30 100%)",
                  }}>
                  <svg
                    width="16"
                    height="16"
      ...
      <div className="lg:hidden flex items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center">
          {blok.logo && blok.logo.filename ? (
            ...
            <div className="flex flex-col">
              <span className="text-[#AF1B3C] font-bold text-lg font-[BelfiusMontserrat]">
                jaimy
              </span>
              <span className="text-gray-400 text-xs font-[BelfiusMontserrat]">
                by Belfius
              </span>
            </div>
          )}
          ...
          <div className="p-4 space-y-4">
            ...
            {languageEnabled && (
              <div className="space-y-2">
                <p className="text-sm font-medium text-gray-700 font-[BelfiusMontserrat]">
                  Language
                </p>
