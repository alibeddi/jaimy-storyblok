        ...
        <div className="block md:hidden">
          <div className="flex flex-col items-center justify-center text-center space-y-6 sm:space-y-8">
            ...
            <p
              ...
              {blok?.description ||
                "Body text Body text Body text Body text Body text Body text Body text Body text Body text Body text Body text Body text Body text Body text Body text Body text Body text"}
            </p>
            ...
            <div className="flex flex-col gap-4 pt-4 w-full max-w-md">
              {blok?.trust_badges?.map((badge, index) => (
                <div
                  key={index}
                  className="relative min-h-[70px] transition-all duration-300 hover:scale-[1.02]">
                  <div
            ...
            <div
              ...
              {blok?.iframe_block ? (
                <div
                  ...
                  <StoryblokComponent
                    blok={blok.iframe_block?.[0] as IframeBlok}
                  />
                </div>
              ) : (
                <div
                ...
                <div className="flex flex-wrap flex-col  md:flex-nowrap gap-4 md:gap-6 lg:flex-row md:pt-6 w-full max-w-2xl">
                  ...
                  {(!blok?.trust_badges || blok.trust_badges.length === 0) && (
                    <>
                      <div
                        className="relative transition-all duration-300 hover:scale-[1.02]"
                        style={{ width: "300px", height: "83px" }}>
                        <div
                          className="absolute inset-0 rounded-3xl transition-all duration-300"
                          style={{
                            background: "#F4F4F4",
                            boxShadow:
                              "-5px 7px 17.3px -2px rgba(0, 0, 0, 0.59)",
                            opacity: "0.5",
                          }}
                        />
                        <div className="relative flex items-center h-full px-6">
